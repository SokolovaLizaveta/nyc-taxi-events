...
| Ноутбук | Описание |
|---|---|
| [yellow_taxi_pickups_2025_01.ipynb](notebooks/yellow_taxi_pickups_2025_01.ipynb) | Очистка, EDA и подготовка данных Yellow Taxi за январь 2025 года. Аналогичные ноутбуки подготовлены для остальных месяцев 2025 года. |
| [event_days_2025.ipynb](notebooks/event_days_2025.ipynb) | Анализ источников информации о концертах и подготовка данных о датах проведения мероприятий. |
| [build_dataset_EDA.ipynb](notebooks/build_dataset_EDA.ipynb) | Объединение данных о поездках и концертах, формирование итогового датасета для моделирования, проведение EDA и сохранение обработанных данных. |
| [modeling.ipynb](notebooks/modeling.ipynb) | Построение, сравнение и настройка моделей прогнозирования спроса. Исследование влияния признака `event_day` на качество прогноза. |
